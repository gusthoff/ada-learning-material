...
.. code:: ada compile_button project=Courses.Advanced_Ada.Access_Types.Uniform_Table
    ...
    private
       ...
       Calc_Table : constant
         array (Quality_Level, 1 .. 5) of Float :=
           (Simplified => (0.15, 0.00, 0.00,
                           0.00, 0.00),
            Better     => (0.02, 0.16, 0.27,
                           0.00, 0.00),
            Best       => (0.01, 0.08, 0.12,
                           0.20, 0.34));

       Last : constant
         array (Quality_Level) of Positive :=
           (Simplified => 1,
            Better     => 3,
            Best       => 5);
...
.. code:: ada compile_button project=Courses.Advanced_Ada.Access_Types.Uniform_Table
    ...
    private
       ...
       Calc_Table : constant
         array (Quality_Level) of Table_Coefficient :=
           (Simplified => (1, (0.15, 0.00, 0.00,
                               0.00, 0.00)),
            Better     => (3, (0.02, 0.16, 0.27,
                               0.00, 0.00)),
            Best       => (5, (0.01, 0.08, 0.12,
                               0.20, 0.34)));
...
.. code:: ada compile_button project=Courses.Advanced_Ada.Access_Types.Ragged_Table
    ...
    private
       ...
       Calc_Table : constant
         array (Quality_Level) of Coefficients :=
           (Simplified => new Data'(1 => 0.15),
            Better     => new Data'(0.02, 0.16, 0.27),
            Best       => new Data'(0.01, 0.08, 0.12,
                                    0.20, 0.34));
...
.. code:: ada compile_button project=Courses.Advanced_Ada.Access_Types.Ragged_Array_Aliased_Objs
    ...
    private
       ...
       Tab_1 : aliased constant
                 Integer_Array := (1 => 15);
       Tab_2 : aliased constant
                 Integer_Array := (12, 15, 20);
       Tab_3 : aliased constant
                 Integer_Array := (12, 15, 20,
                                   20, 25, 30);

       Table : constant
         array (1 .. 3) of Integer_Array_Access :=
           (1 => Tab_1'Access,
            2 => Tab_2'Access,
            3 => Tab_3'Access);
...
.. code:: ada run_button project=Courses.Advanced_Ada.Access_Types.User_Defined_References
    ...
    procedure Show_User_Defined_Reference is
       ...
       --  Reference type:
       type Id_Ref (Ref : access Id_Number)
         is null record
           with Implicit_Dereference => Ref;
    ...
    package body National_Date_Info is
       ...
       begin
          Put_Line ("Country: "
                    & Nat_Date.Country);
          Put_Line ("Year:    "
                    & Integer'Image (Nat_Date.Date.Year));
       end Show;
       ...
       begin
          for I in Nat_Dates'Range loop
             if Nat_Dates (I).Country = Country then
                return National_Date_Reference'(
                  Ref => Nat_Dates (I));
                --     ^ Returning reference object with
                --       a reference to the national day
                --       we found.
             end if;
          end loop;
...
.. admonition:: Relevant topics
    ...
    .. code:: ada compile_button project=Courses.Advanced_Ada.Access_Types.National_Dates
        ...
        package Generic_Containers is
           ...
           type Container is
             array (Positive range <>) of T_Access;
...
.. code:: ada run_button project=Courses.Advanced_Ada.Access_Types.Unchecked_Deallocation_Error
    ...
    procedure Show_Unchecked_Deallocation_Errors is
       ...
       --  ERROR: Cannot use access-to-constant
       --         type for Name
       procedure Free is new
         Ada.Unchecked_Deallocation
           (Object => Integer,
